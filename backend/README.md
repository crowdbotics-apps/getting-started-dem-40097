...
## Project Structure
    ...
    ├── getting_started_dem_40097  # Django project configurations
...
1. Clone this repo and `cd getting_started_dem_40097`
...
2. Clone this repo and `cd getting_started_dem_40097`
